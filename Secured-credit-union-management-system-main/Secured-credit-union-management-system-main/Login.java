...
public class Login extends JFrame implements ActionListener{
    ...
    Login() {
        ...
        text.setBounds(300, 40, 800, 40);
        add(text);
        
        JLabel cardno = new JLabel("Card No:");
        cardno.setFont(new Font("Raleway", Font.BOLD, 28));
        cardno.setBounds(170, 180, 200, 40);
        add(cardno);
        
        cardTextField = new JTextField();
        cardTextField.setBounds(330, 185, 300, 30);
        ...
        pin.setBounds(190, 260, 800, 40);
        add(pin);
        
        pinTextField = new JPasswordField();
        pinTextField.setBounds(330, 265, 300, 30);
        ...
        signup.setBounds(350, 400, 100, 30);
