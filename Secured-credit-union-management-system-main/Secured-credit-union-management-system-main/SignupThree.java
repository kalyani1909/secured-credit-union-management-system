...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-9132");
        ...
        c2 = new JCheckBox("Digital Pass Book");
        ...
        c4 = new JCheckBox("I hereby declares that enetered details are correct");
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raleway", Font.BOLD, 12));
        c4.setBounds(100, 630, 380, 30);
        add(c4);
